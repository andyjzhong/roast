...
-   Work on delete button functionality.
...
-   Delete button was more complicated than I thought. I started with removing the selected item by traversing the DOM and using the splice() array method, deleting only the first item on the tab. The more difficult part was resetting the item number displayed to the user.
...
| Add Application Logic      | 5.5 hrs     | 2 hrs       | 0 hr      |
